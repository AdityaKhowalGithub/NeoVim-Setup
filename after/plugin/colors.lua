...
function ToggleCatppuccinMode()
    ...
    -- Determine the new mode based on the current setting
            ...
            highlight_overrides = {
                all = function(colors)
                    return {
                        ...
                        -- TelescopePreviewBorder = { bg = colors.text, fg = colors.crust },
                        -- TelescopePreviewNormal = { bg = colors.crust },
                        -- TelescopePreviewTitle = { fg = colors.crust, bg = colors.crust },
                        -- TelescopePromptBorder = { bg = colors.text, fg = colors.surface0 },
                        -- TelescopePromptCounter = { fg = colors.mauve, style = { "bold" } },
                        -- TelescopePromptNormal = { bg = colors.surface0 },
                        -- TelescopePromptPrefix = { bg = colors.surface0 },
                        -- TelescopePromptTitle = { fg = colors.surface0, bg = colors.surface0 },
                        -- TelescopeResultsBorder = { bg = colors.text, fg = colors.mane },
