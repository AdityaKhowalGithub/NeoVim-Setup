...
map("n", "<leader>si", "<cmd>DapStepInto<CR>", { desc = "Step Into" })
map("n", "<leader>so", "<cmd>DapStepOut<CR>", { desc = "Step Out" })
map("n", "<leader>dl", "<cmd>DapListBreakpoints<CR>", { desc = "List Breakpoints" })
map("n", "<leader>dr", "<cmd>DapRestart<CR>", { desc = "Restart Debugging" })
map("n", "<leader>dq", "<cmd>DapTerminate<CR>", { desc = "Terminate Debugging" })

-- Iron (REPL) keymaps
map("n", "<leader>i", "<cmd>IronRepl<CR>", { desc = "Toggle REPL" })
map("n", "<leader>I", "<cmd>IronRestart<CR>", { desc = "Restart REPL" })
map("n", "+", function() require('iron.core').send("text") end, { desc = "Send-to-REPL Operator" })
map("n", "++", function() require('iron.core').send(vim.fn.getline('.')) end, { desc = "Send Line to REPL" })
